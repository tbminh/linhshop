...
@section('content')
            ...
            <div class="cart-list">
                ...
                <div class="single-cart-item">
                    <a href="#" class="product-image">
                        <img src="{{asset('public/page_admin/img/product-img/product-1.jpg')}}" class="cart-thumb" alt="">
                        <!-- Cart Item Desc -->
                ...
                <div class="single-cart-item">
                    <a href="#" class="product-image">
                        <img src="{{asset('public/page_admin/img/product-img/product-2.jpg')}}" class="cart-thumb" alt="">
                        <!-- Cart Item Desc -->
                        <div class="cart-item-desc">
                            <span class="product-remove"><i class="fa fa-close" aria-hidden="true"></i></span>
                            <span class="badge">Mango</span>
                ...
                <div class="single-cart-item">
                    <a href="#" class="product-image">
                        <img src="{{asset('public/page_admin/img/product-img/product-3.jpg')}}" class="cart-thumb" alt="">
                        <!-- Cart Item Desc -->
                        <div class="cart-item-desc">
                            <span class="product-remove"><i class="fa fa-close" aria-hidden="true"></i></span>
                            <span class="badge">Mango</span>
    ...
    <div class="single-blog-wrapper">
        ...
        <div class="single-blog-post-thumb">
            <img src="{{asset('public/page_admin/img/bg-img/bg-7.jpg')}}" alt="">
        </div>
        ...
        <div class="single-blog-content-wrapper d-flex">
            ...
            <div class="related-blog-post">
                ...
                <div class="single-related-blog-post">
                    <img src="{{asset('public/page_admin/img/bg-img/rp1.jpg')}}" alt="">
                    <a href="#">
                ...
                <!-- Single Related Blog Post -->
                <div class="single-related-blog-post">
                    <img src="{{asset('public/page_admin/img/bg-img/rp2.jpg')}}" alt="">
                    <a href="#">
                ...
                <!-- Single Related Blog Post -->
                <div class="single-related-blog-post">
                    <img src="{{asset('public/page_admin/img/bg-img/rp3.jpg')}}" alt="">
                    <a href="#">
                ...
                <!-- Single Related Blog Post -->
                <div class="single-related-blog-post">
                    <img src="{{asset('public/page_admin/img/bg-img/rp4.jpg')}}" alt="">
                    <a href="#">
